...
export function findPassenger(passengers, name) {
  ...
  return passengers.find( n=> n.name.toUpperCase() === name.trim().toUpperCase())
}
...
export function getPassengerIndex(passengers, name) {
  ...
  return passengers.findIndex( n=> n.name.toUpperCase() === name.trim().toUpperCase())
}
...
export function isAnyWaitlisted(passengers) {
  ...
  return passengers.some( n=> n.status === 'waitlisted')
}
...
export function areAllConfirmed(passengers) {
  ...
  return passengers.every( n=> n.status === 'confirmed')
}
...
export function getWaitlistedPassengers(passengers) {
  ...
  return passengers.filter( u=> u.status === "waitlisted")
}
